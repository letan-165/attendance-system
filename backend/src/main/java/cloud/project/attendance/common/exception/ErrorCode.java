...
public enum ErrorCode {
    ...
    USER_ROLE_INVALID(2005,"Role không hợp lệ (STAFF, ADMIN, MANAGER)", HttpStatus.BAD_REQUEST),
    USER_STATUS_INVALID(2005,"Trạng thái người dùng không hợp lệ (ACTIVE, BLOCKED)", HttpStatus.BAD_REQUEST),
